/*
Copyright 2012 Igor Vaynberg, IDS AirNav
...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        updateResults: function (initial) {
            ...
            if (initial !== true && opts.ajax && opts.ajax.delay && qryOpts.term !== '') {
                if (window._select2Timeout) {
                    window.clearTimeout(window._select2Timeout);
                }

                window._select2Timeout = setTimeout(function () {
                    opts.query(qryOpts)
                }, opts.ajax.delay);
            } else {
                opts.query(qryOpts);
